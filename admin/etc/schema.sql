...
-- deletion-time referential check is a single lookup by TargetID.
...
-- admin server rebuilds the edges when the configured depth is raised. Holds a
-- single row, managed by the server.
